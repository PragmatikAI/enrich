...
object AtomicFieldsLengthValidator {
  ...
  private val atomicFields =
    List(
      ...
      AtomicField(name = "page_url",           _.page_url,          maxLength = 10000),
      AtomicField(name = "page_title",         _.page_title,        maxLength = 2000),
      AtomicField(name = "page_referrer",      _.page_referrer,     maxLength = 10000),
      ...
      AtomicField(name = "mkt_clickid",        _.mkt_clickid,       maxLength = 5000 ),
